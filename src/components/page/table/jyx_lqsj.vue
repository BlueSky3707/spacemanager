    ...
    data() {
        return {
            ...
            fields:[
                    ...
                    {field: "lqpkdm", alias: "两区片块代码",width:"auto"},	
                    {field: "lqlx", alias: "两区类型",width:"auto"},	
                    {field: "qyhflx", alias: "区划区域类型",width:"auto"},	
                    {field: "lqdkdm", alias: "两区地块代码",width:"auto"},	
                    {field: "lqdkmc", alias: "两区地块名称",width:"auto"},	
                    {field: "lqdkmj", alias: "两区地块面积",width:"auto"},	
                    {field: "lqdkmjm", alias: "两区地块面积亩",width:"auto"},	
                    {field: "zldjdm", alias: "质量等级代码",width:"auto"},	
                    {field: "qsdwdm", alias: "权属单位代码",width:"auto"},	
                    {field: "qsdwmc", alias: "权属单位名称",width:"auto"},	
                    {field: "pdjb", alias: "坡度级别",width:"auto"},	
                    {field: "sfgbznt", alias: "是否高标准农田",width:"auto"},	
                    {field: "jyztmc", alias: "经营主体名称",width:"auto"},	
                    {field: "jyztlx", alias: "经营主体类型",width:"auto"},	
                    {field: "frdbs", alias: "飞入地标识",width:"auto"},	
                    {field: "bz", alias: "备注",width:"auto"}


            ],
            searchfields:["bsm","ysdm","lqdkmc"],
            query: {
                layerName:"jyx_lqsj",
