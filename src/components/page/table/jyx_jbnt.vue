    ...
    data() {
        return {
            ...
            fields:[
                ...
                {field: "jbnttbbh", alias: "基本农田图斑编号",width:"auto"},
                ...
                {field: "zldwdm", alias: "坐落单位代码",width:"auto"},	
                {field: "zldwmc", alias: "坐落单位名称",width:"auto"},	
                {field: "gdlx", alias: "耕地类型",width:"auto"},	
                {field: "jbntlx", alias: "基本农田类型",width:"auto"},	
                {field: "pdjb", alias: "坡度级别",width:"auto"},	
                {field: "kclx", alias: "扣除类型",width:"auto"},	
                {field: "kcdlbm", alias: "扣除地类编码	",width:"auto"},
                {field: "tkxs", alias: "扣除地类系数",width:"auto"},	
